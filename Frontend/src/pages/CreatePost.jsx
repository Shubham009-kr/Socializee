...
const CreatePost = () => {
  ...
  return (
    <section className="w-full max-w-full h-full flex flex-col items-center justify-start bg-teal-950 text-[#ffffff]">
      ...
      alt="Create Post" className="w-1/2 h-full object-cover flex items-center justify-center"/> */}
        <div className="w-1/2 h-full border-1 border-t-0 border-b-0 border-gray-700 outline-gray-800 shadow-xl/30 flex items-center justify-start flex-col bg-cover rounded-4xl bg-[url(https://plus.unsplash.com/premium_photo-1710286469759-a15530a4607d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]">
            <div className="w-full h-full flex rounded-4xl items-center justify-center flex-col bg-gradient-to-b from-black-100 to-gray-900 gap-10">
              ...
              <div className="w-1/2 h-1/3 rounded-3xl shadow-2xl border-1 border-gray-500 border-t-0 border-b-2 flex items-center justify-center flex-col bg-gradient-to-b from-gray-600 to-gray-950 hover:scale-110 transition-transform duration-250">
              ...
              <div className="w-1/2 h-1/5 rounded-3xl shadow-2xl border-1 border-gray-600 border-t-0 border-b-2 flex items-center justify-center gap-4 bg-gradient-to-b from-gray-800 to-gray-950 hover:scale-110 transition-transform duration-250">
